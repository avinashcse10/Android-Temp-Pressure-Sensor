...
public class CompareSensorActivity extends Activity implements SensorEventListener, ConnectionCallbacks, OnConnectionFailedListener{
    ...
    public class WeatherAsyncTask extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... params) {
            ...
            String urlparams = mUrlString +"lat="+mLastKnownLocation.getLatitude()+
                    "&lon="+mLastKnownLocation.getLongitude()+"&units=metric&APPID="+AppId;
            try {
                ...
                BufferedReader mBufferedReader =
                        new BufferedReader(new InputStreamReader(mHttpURLConnection.getInputStream()));
                String inputLine;
